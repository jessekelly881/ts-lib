...
export const zebraThreeSolution = {
  houses: [
    { animal: "Horses", color: "Blue", nationality: "British", sport: "Swimming" },
    { animal: "Dolphins", color: "Black", nationality: "American", sport: "Handball" },
    { animal: "Turtles", color: "Red", nationality: "Canadian", sport: "Tennis" },
    { animal: "Butterflies", color: "White", nationality: "Irish", sport: "Bowling" },
  ],
} as const;
